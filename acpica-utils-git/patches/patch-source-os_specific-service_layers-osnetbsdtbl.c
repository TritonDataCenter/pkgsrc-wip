...
--- source/os_specific/service_layers/osnetbsdtbl.c.orig	2015-03-07 12:26:48.000000000 +0000
+++ source/os_specific/service_layers/osnetbsdtbl.c
@@ -0,0 +1,963 @@
+/******************************************************************************
+ *
+ * Module Name: osnetbsdtbl - NetBSD OSL for obtaining ACPI tables
+ *
+ *****************************************************************************/
+
+/******************************************************************************
