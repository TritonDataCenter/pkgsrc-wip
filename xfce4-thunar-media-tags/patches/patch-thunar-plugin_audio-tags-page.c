...
--- thunar-plugin/audio-tags-page.c.orig	2006-09-11 09:40:56.000000000 +0000
+++ thunar-plugin/audio-tags-page.c
@@ -32,7 +32,6 @@
...
@@ -282,10 +280,6 @@ audio_tags_page_init (AudioTagsPage *pag
...
@@ -317,7 +311,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Track spin button */
...
@@ -340,7 +334,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Year spin button */
   spin = gtk_spin_button_new (GTK_ADJUSTMENT (adjustment), 1, 0);
...
+  gtk_widget_set_tooltip_text (GTK_WIDGET (spin), _("Enter the release year here."));
   ...
   gtk_label_set_mnemonic_widget (GTK_LABEL (label), spin);
   gtk_widget_show (spin);
@@ -355,7 +349,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Artist entry */
   entry = gtk_entry_new ();
...
@@ -370,7 +364,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Title entry */
   entry = gtk_entry_new ();
...
@@ -384,7 +378,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Album entry */
   entry = gtk_entry_new ();
...
@@ -398,7 +392,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Comment entry */
   entry = gtk_entry_new ();
...
@@ -412,7 +406,7 @@ audio_tags_page_init (AudioTagsPage *pag
   /* Genre combo box */
...
@@ -512,9 +506,6 @@ audio_tags_page_finalize (GObject *objec
...
@@ -977,8 +968,8 @@ audio_tags_page_info_activate (GtkAction
...
@@ -1007,9 +998,9 @@ audio_tags_page_info_activate (GtkAction
...
@@ -1121,7 +1112,7 @@ audio_tags_page_info_activate (GtkAction
   g_free (filesize);
   g_free (mimetype);
